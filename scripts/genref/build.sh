...
SITE_DIR=${API_REF_SCRIPT_DIR}/../../content/docs
API_REFERENCE_DIR=${SITE_DIR}/reference
mkdir -p ${API_REFERENCE_DIR}
cat ${API_REF_SCRIPT_DIR}/index-header.md ${BUILD_TEMP_OUT}/* > ${API_REFERENCE_DIR}/api.md
